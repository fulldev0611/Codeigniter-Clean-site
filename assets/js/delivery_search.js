(function($) {
  ...
  // Leo: Ajax methodology to search services.
  $( document ).ready(function() {
    ...
    // Leo: myVar to prevent huge amount of calling of get_services() func
    var myVar = null;
  ...
  function get_services(page) { 
    ...
    if (pagination_page === null || pagination_page === undefined) {
      pagination_page = base_url + "home/ajaxPaginationData1/";
    }
