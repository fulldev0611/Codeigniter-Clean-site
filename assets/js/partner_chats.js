(function($) {
  ...
  function loadInviteable(){
    ...
    $.ajax({
      url:base_url+"partner/Chat_ctrl/load_inviteable",
      type:"post",
  ...
  function submitInvite(token){
    ...
    $.ajax({
      url: base_url+"partner/Chat_ctrl/save_invite",
      type:"post",
  ...
  function acceptInvite(){
    ...
    $.ajax({
      url: base_url+"partner/Chat_ctrl/accept_invite",
      type:"post",
      data:{'chat_room':chat_room, 'csrf_token_name':csrf_token},
      async:false,
      success(data){
  ...
  function chat_clear(){
    ...
    $.ajax({
      ...
      url:base_url+"partner/Chat_ctrl/clear_history",
      type:"post",
  ...
  function get_user_chat_lists(){
    $.ajax({
      url:base_url+"partner/Chat_ctrl/get_user_chat_lists",
      type:"post",
  ...
  function history_append_fun(token){
    ...
    $.ajax({
      url:base_url+"partner/Chat_ctrl/changeToRead_ctrl",
      type:"post",
  ...
  function loadMessageBox(token) {
    ...
    var self_token = $('#self_token').val();
    $.ajax({
      url:base_url+"partner/Chat_ctrl/get_chat_history",
      type:"post",
      data:{'partner_token':token,'self_token':self_token,'csrf_token_name':csrf_token},
      async:false,
      success:function(data){
        $.ajax({
          url:base_url+"partner/Chat_ctrl/get_token_informations",
          type:"post",
          data:{'partner_token':token,'self_token':self_token,'csrf_token_name':csrf_token},
          async:false,
  ...
  function btn_send(){
    ...
    $.post(base_url+'partner-chat/insert_chat',{fromToken: $('#fromToken').val(),toToken:$('#toToken').val(), chat_room:$('#chat_room').val(), content:$('#chat-message').val(),csrf_token_name:csrf_token}, function(response){
