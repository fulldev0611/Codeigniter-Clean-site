(function($) {
  ...
  $('#addSubscription').bootstrapValidator({
    ...
    $.ajax({
     ...
     data : {subscription_name:subscription_name,fee_description:fee_description,subscription_amount:amount,subscription_duration:duration,subscription_limit:limit,status:status,csrf_token_name:csrf_token},
     success:function(response)
     {
       if(response==1)
       {
...
$('#editSubscription').bootstrapValidator({
  ...
  $.ajax({
   ...
   data : {subscription_id:subscription_id,subscription_name:subscription_name,fee_description:fee_description,subscription_amount:amount,subscription_duration:duration,subscription_limit:limit,status:status,csrf_token_name:csrf_token,},
   success:function(response)
   {
     if(response==1)
     {
...
// ---- Leo: loader function definition -----------
function hideLoader() {
...
// Leo: common toaster alert func definition
