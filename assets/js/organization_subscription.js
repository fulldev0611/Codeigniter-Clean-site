(function($) {
	...
	$( document ).ready(function() {
		...
		$(".pay_by_stripe").on("click", function() {
			...
			$.ajax({
                url: base_url + 'create-stripe-organization-subscription',
                type: 'post',
                dataType: 'json',
		...
		$(".pay_by_paypal").on("click", function() {
			...
			$.ajax({
                ...
                success: function (response) {
                    ...
                    window.location.href = base_url+'paypal-organization-subscription/'+subscription_id+"/"+plan_id;
                },
                error: function (error) {
                    hideLoader();
                    console.error(error.status, error.statusText);
					...
					"handler": function (response){
						  $.ajax({
							...
							success: function (msg) {						
							  window.location.href = base_url+'organization-subscription';
							}
						});
					},
					"theme": {
