				...
				<div class="row">
					<div class="col-lg-7 col-md-7">
						<div class="copyright-text">
							<p class="mb-0"><?=strtoupper($this->website_name)." LTD"?> &copy;2018 - <?php echo date('Y')?> registered <br><!-- 35 High Street, Braithwell, Rotherham,  -->England & Wales<!-- , S66 7AW --> (Company No. 11459871)</p>
						</div>
					</div>
...
<script src="<?php echo base_url();?>assets/js/functions.js?v1.08"></script>
