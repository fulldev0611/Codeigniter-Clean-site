...
<div data-v-60e7013d="" class="row mt-15 our-services">
    <div data-v-60e7013d="" class="per-block-header">
        ...
        <p>Quickly extend innovative meta-services for multifunctional paradigms. Distinctively customize focused experiences through vertical best practices.</p>
    </div>
...
<section class="client-say-section section">
    <div class="row">
        <div class="col-12 section-header">
            <h2 class="header-text">WHAT'S CLIENT'S SAY</h2>
...
<section class="latest-blog-section section">
    ...
    <div class="blog-block row">
        <div class="blog-carousel owl-carousel">
                ...
                <div class="card blog-block-item">
                  ...
                  <div class="card-body blog-block-item-content">
                    ...
                    <div class="item-bottom">
                        <a href="<?=base_url()?>blog" class="read-more"> 
                            Read More
                            <i class="fa fa-arrow-right" aria-hidden="true"></i>
                        </a>
                    </div>
            ...
            <!-- <div class="item">
                <div class="card blog-block-item">
                  <img class="card-img-top blog-img" src="<?=base_url()?>assets/img/<?=TEMPLATE_THEME?>/rain-showerhead.png" transition="scale-transition">
                  <div class="card-body blog-block-item-content">
                    <div class="card-title item-title">
                        <h3 class="blog-title">How To Clean Shower Heads?</h3>
                        <span class="blog-date">
                            <i class="fa fa-calendar-minus-o" aria-hidden="true"></i>
                            <?=date("j M Y",strtotime("2021=7-21"))?>
                        </span>
                        <span class="blog-author">
                            <i class="fa fa-user-o" aria-hidden="true"></i>
                            Post by Admin
                    ...
                    <p class="card-text">Ever wonder when cleaning our homes, we meticulously did all the necessary stuff to keep our homes from looking dirty? Yes, we do, and we continuously make sure it remains in that way.</p>
                    <hr>
                    <div class="item-bottom">
                        <a href="<?=base_url()?>blog" class="read-more"> 
                            Read More
            ...
            <div class="item">
                <div class="card blog-block-item">
                  <img class="card-img-top blog-img" src="<?=base_url()?>assets/img/<?=TEMPLATE_THEME?>/office-buildings.png" transition="scale-transition">
                  <div class="card-body blog-block-item-content">
                    <div class="card-title item-title">
                        <h3 class="blog-title">How To Clean Shower Heads?</h3>
                        <span class="blog-date">
            ...
            <div class="item">
                <div class="card blog-block-item">
                  <img class="card-img-top blog-img" src="<?=base_url()?>assets/img/<?=TEMPLATE_THEME?>/portrait-woman.png" transition="scale-transition">
                  <div class="card-body blog-block-item-content">
                    <div class="card-title item-title">
                        <h3 class="blog-title">How To Clean Shower Heads?</h3>
                        <span class="blog-date">
