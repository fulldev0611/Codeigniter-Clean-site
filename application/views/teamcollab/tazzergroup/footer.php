						...
						<form action="" method='post' id="new_third_page">
							...
							<div class="form-group">
								<div class="custom-control custom-control-xs custom-checkbox">
									...
									<label class="custom-control-label" for="agree_checkbox"><?php echo (!empty($user_language[$user_selected]['lg_agree'])) ? $user_language[$user_selected]['lg_agree'] : $default_language['en']['lg_agree']; ?> <?=$this->website_name?></label> <a tabindex="-1" href="javascript:void(0);">Privacy Policy</a> &amp; <a tabindex="-1" href="javascript:void(0);"> Terms.</a>
								</div>
							</div>
							<div class="form-group">
...
<?php if($this->uri->segment(1)!="join-us"){ ?>
							...
							<form method='post' id="new_third_page_user">
							 ...
							 <div class="row">
	                           <div class="form-group col-md-6 mt-3">
									...
									<input type="text" class="form-control border-dark" name="userName" id='user_name' minlength="3" value="<?=$registerInput['name']?>" placeholder="First Name">
								</div>
	                           <div class="form-group col-md-6 mt-3">
								...
								<div class="form-group col-md-4 mt-3">
									...
									<input type="text" name="house_name" id="h_name" value="" placeholder="House Name" class="form-control border-dark" value="<?=$registerInput['house_name']?>">
								</div>
								<div class="form-group col-md-4 mt-3">
									<label>House or flat number</label>
									<input type="text" name="house_number" id="h_number" value="" placeholder="House or flat number" class="form-control border-dark" value="<?=$registerInput['house_number']?>">
								</div>
								<div class="form-group col-md-4 mt-3">
									<label>Street Address</label>
									<input type="text" name="street_address" id="st_address" value="" placeholder="Enter Street Address" class="form-control border-dark" value="<?=$registerInput['street_address']?>">
								</div>

								<div class="form-group col-md-4 mt-3">
									<label>City</label>
									 <input type="text" name="city" id="c_city" value="" placeholder="Enter City" class="form-control border-dark" value="<?=$registerInput['city']?>">
								</div>
								<div class="form-group col-md-4 mt-3">
									<label> County/ Province</label>
									<input type="text" name="province" id="p_province" value="" placeholder="Enter Province" class="form-control border-dark" value="<?=$registerInput['province']?>">
								</div>
								<div class="form-group col-md-4 mt-3">
								...
								<div class="form-group col-md-6 mt-3">
									...
									<input type="text" class="form-control user_final_no user_mobile border-dark" placeholder="Enter Mobile No" name="userMobile" id='user_mobile' value="<?=$registerInput['mobileno']?>">
								</div>
							</div>
								<div class="form-group">
									<div class="custom-control custom-control-xs custom-checkbox">
										<input type="checkbox" class="custom-control-input" name="agreeCheckboxUser" id="agree_checkbox_user" value="1">
										<label class="custom-control-label" for="agree_checkbox_user">I agree to <?=$this->website_name?></label> <a tabindex="-1" href="<?=base_url()?>privacy" target="_blank">Privacy Policy</a> &amp; <a tabindex="-1" href="<?=base_url()?>terms-conditions" target="_blank"> Terms.</a>
									</div>
								</div>
								<div class="form-group">
	...
	<div class="footer-top">
		<div class="container">
			<div class="row">
				        ...
				        <ul>
				          <li class="color-grey">
				            <a href="<?php echo base_url();?>">
								<h1 style = "color:white; font-size: 35px; margin-bottom:20px; ">
									TeamCollab
								</h1>	

							</a>
							<p>Team Collab provides high quality, professional and on-demand, services that are fully trusted and convenient with a highly professional team. We provide safe vehicles and professional experts, which means you can expect a first class, reliable service. Call Tazzer Group today</p>
				          ...
				          <li class="color-grey">
							...
							<p>
								<a href="tel:+44-079-6124-2587">
									<span style="font-size:16px"><img src="<?php echo base_url(); ?>assets/img/call.3c7e5ae4.svg">&nbsp; &nbsp; 079 6124 2587 </span>
								</a>
							</p>
							<p>
								<a href="tel:+44-033-3404-1413">
									<span style="font-size:16px"><img src="<?php echo base_url(); ?>assets/img/call.3c7e5ae4.svg">&nbsp; &nbsp; 033 3404 1413 </span>
								</a>
							</p>
							<p>
								<a href="mailto:info@<?=str_replace("www.","",base_uri())?>">
									<span style="font-size:16px"><img src="<?php echo base_url(); ?>assets/img/mail-box.394d51c7.svg">&nbsp; &nbsp;info@<?=str_replace("www.","",base_uri())?></span>
								</a>
							</p>
				      		<!-- <p><img src="<?php echo base_url(); ?>assets/img/mail-box.394d51c7.svg" />&nbsp; &nbsp;For Support :</p>
				      		<p>&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;support@<?php echo $final_print2; ?></p> -->
				      		<!-- <p><img src="<?php echo base_url(); ?>assets/img/mail-box.394d51c7.svg" />&nbsp; &nbsp;For Business :</p>
				      		<p>&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;business@<?php echo $final_print2; ?></p> -->
				          </li>
				        </ul>
				      </div>
				    </div>
				...
				<?php 
					$deliveryModules = ["delivery", "deliveries", "delivery_details"];
					if (in_array($module, $deliveryModules)) {
						?>
				<div class="col-lg-3 col-md-6">
				  <div class="footer-widget footer-menu">
				  	<h2 class="footer-title">Popular Deliveries</h2>
                    <div class="footer-line">
                        <span></span>
                    </div>
				    <div class="about">
				      <div class="contactdet">
				        <ul>
				          <li class="color-grey">
							<ul>
							<li><a href="<?php echo base_url('b2b/Reqforquote'); ?>">Request for Quote</a></li>
							<?php foreach ($popularDeliveryCategories as $popular_category) { ?>
								<li><a href="<?php echo base_url()."delivery-details/".$popular_category["id"]."/".replace_specials(strtolower(trim($popular_category['category_name']))); ?>"><?=$popular_category['category_name'] ?></a></li>
							<?php } ?>
				    ...
				    <div class="about">
				      <div class="contactdet">
				        <ul>
				          ...
				          <li class="color-grey">
							<ul>
							<li><a href="<?php echo base_url('b2b/Reqforquote'); ?>">Request for Quota </a></li>
							<?php foreach ($popularCategories as $popular_category) { ?>
								<li><a href="<?php echo base_url()."service-category-detail/".$popular_category["id"]; ?>"><?=$popular_category['category_name'] ?></a></li>
							<?php } ?>

								<!-- <li><a href="<?php echo base_url(); ?>search/cleaning-services">Cleaning Services </a></li>
								<li><a href="<?php echo base_url(); ?>search/clearance-and-rubbish-removal-services">Clearance &amp; Rubbish Removal Services</a></li>
								<li><a href="<?php echo base_url(); ?>search/dog-walking-adn-pet-services">Dog Walking &amp; Pet Services </a></li>
								<li><a href="<?php echo base_url(); ?>search/domestic-helpers-services">Domestic Helpers Services</a></li>
								<li><a href="<?php echo base_url(); ?>search/gardening-services">Gardening Services</a></li>
								<li><a href="<?php echo base_url(); ?>search/handyman-services">Handyman Services </a></li>
								<li><a href="<?php echo base_url(); ?>search/property-management-services">Property Management Services</a></li>
								<li><a href="<?php echo base_url(); ?>search/scaffolding-and-building-services">Scaffolding &amp; Building Services </a></li> 
				        ...
				        <ul>
				          ...
				          <li class="color-grey">
							<ul>
								...
								<li><a href="<?php echo base_url(); ?>about_us"><?php echo (!empty($user_language[$user_selected]['lg_about'])) ? $user_language[$user_selected]['lg_about'] : $default_language['en']['lg_about']; ?></a></li>
								<li><a href="<?php echo base_url(); ?>career">CARRER</a></li>
								<li><a href="<?php echo base_url(); ?>career/meeting">BOOK A MEETING</a></li>
				...
				<div class="row">
					<div class="col-lg-7 col-md-7">
						<div class="copyright-text">
							<p class="mb-0"><?=strtoupper($this->website_name)." LTD"?> &copy;<?php echo date('Y')?> registered <br><!-- 35 High Street, Braithwell, Rotherham,  -->England & Wales<!-- , S66 7AW --> (Company No. 11459871)</p>
						</div>
					</div>
...
<!-- Leo: add ImgUploader -->
<script src="<?=base_url()?>assets/plugins/ImgUploader/croppie.min.js"></script>
<script src="<?=base_url()?>assets/plugins/ImgUploader/imguploader.bs.js?v1.0"></script>
...
<?php if($module=='service' || $module == 'chat' || $module == 'terms' || $module == 'privacy'){ ?>
	...
	<script src="<?php echo base_url();?>assets/js/service.js?v1.01"></script>
...
<?php 
	...
	if($page=='home' || in_array($module, $placeValidModules)) { 
		?>
	...
	<script src="<?php echo base_url();?>assets/js/place.js?v1.09"></script>
<?php } ?>
...
<script src="<?php echo base_url();?>assets/js/functions.js?v1.09"></script>
...
<?php if($this->uri->segment(2)=="time-clocked"){ ?>
	<script src="<?php echo base_url();?>assets/js/time_clock.js"></script>
<?php } ?>
<!-- login -->
<?php if(empty($this->session->userdata('id'))){?>
	<script src="<?php echo base_url(); ?>assets/js/login.js?v1.14"></script>
<?php }?>

<script src="<?php echo base_url();?>assets/js/script.js?v1.06"></script>

<!-- External js-->
<?php if($this->uri->segment(1)=="user-chat"){ ?>
	<script src="<?php echo base_url(); ?>assets/js/user_chats.js?v1.06"></script>
<?php }?>
...
<?php if($this->uri->segment(1)=="provider-subscription"){ ?>
	<script src="<?php echo base_url(); ?>assets/js/provider_subscription.js?v1.06"></script>
<?php }?>

<?php if($this->uri->segment(1)=="business-subscription"){ ?>
	<script src="<?php echo base_url(); ?>assets/js/business_subscription.js"></script>
<?php }?>
...
<?php if($this->uri->segment(1)=="all-services" ||$this->uri->segment(1)=="search"){ ?>
	<script src="<?php echo base_url(); ?>assets/js/service_search.js?v1.06"></script>
<?php }?>
<?php if($this->uri->segment(1)=="all-deliveries" ||$this->uri->segment(1)=="delivery-search"){ ?>
	<script src="<?php echo base_url(); ?>assets/js/delivery_search.js"></script>
<?php }?>
...
<?php if($this->uri->segment(1)=="employee-orders"){ ?>
	<script src="<?php echo base_url(); ?>assets/js/employee_orders.js"></script>
<?php }?>
<?php if($this->uri->segment(1)=="employee-chat"){ ?>
	<script src="<?php echo base_url(); ?>assets/js/employee_chats.js?v1.05"></script>
<?php }?>
<?php if($this->uri->segment(1)=="employee-wallet"){ ?>
	<script src="<?php echo base_url(); ?>assets/js/employee_wallet.js?v1.0"></script>
<?php }?>
<?php if($this->uri->segment(1)=="employee-subscription"){ ?>
	<script src="<?php echo base_url(); ?>assets/js/employee_subscription.js?v1.01"></script>
<?php }?>
<?php if($this->uri->segment(1)=="soletrader-subscription"){ ?>
	<script src="<?php echo base_url(); ?>assets/js/soletrader_subscription.js?v1.01"></script>
<?php }?>
<?php if($this->uri->segment(1)=="self-employed-subscription"){ ?>
	<script src="<?php echo base_url(); ?>assets/js/self_employed_subscription.js?v1.01"></script>
<?php }?>

<?php if($this->uri->segment(1)=="organization-orders"){ ?>
	<script src="<?php echo base_url(); ?>assets/js/organization_orders.js"></script>
<?php }?>
<?php if($this->uri->segment(1)=="organization-chat"){ ?>
	<script src="<?php echo base_url(); ?>assets/js/organization_chats.js?v1.05"></script>
<?php }?>
<?php if($this->uri->segment(1)=="organization-wallet"){ ?>
	<script src="<?php echo base_url(); ?>assets/js/organization_wallet.js?v1.0"></script>
<?php }?>
<?php if($this->uri->segment(1)=="organization-subscription"){ ?>
	<script src="<?php echo base_url(); ?>assets/js/organization_subscription.js?v1.07"></script>
<?php }?>

<?php if($this->uri->segment(1)=="staff-orders"){ ?>
	<script src="<?php echo base_url(); ?>assets/js/staff_orders.js"></script>
<?php }?>
<?php if($this->uri->segment(1)=="staff-chat"){ ?>
	<script src="<?php echo base_url(); ?>assets/js/staff_chats.js?v1.05"></script>
<?php }?>
<?php if($this->uri->segment(1)=="staff-wallet"){ ?>
	<script src="<?php echo base_url(); ?>assets/js/staff_wallet.js?v1.0"></script>
<?php }?>

<?php if($this->uri->segment(1)=="partner-orders"){ ?>
	<script src="<?php echo base_url(); ?>assets/js/partner_orders.js"></script>
<?php }?>
<?php if($this->uri->segment(1)=="partner-chat"){ ?>
	<script src="<?php echo base_url(); ?>assets/js/partner_chats.js?v1.05"></script>
<?php }?>
<?php if($this->uri->segment(1)=="partner-wallet"){ ?>
	<script src="<?php echo base_url(); ?>assets/js/partner_wallet.js?v1.0"></script>
<?php }?>
<?php if($this->uri->segment(1)=="partner-subscription"){ ?>
	<script src="<?php echo base_url(); ?>assets/js/partner_subscription.js?v1.07"></script>
<?php }?>
<!-- ========================= #end maksimU ================================ -->
<!---External js end-->
...
<span id="info_message"><?php echo $this->session->flashdata('info_message');?></span>
...
<?php
	if(!empty($this->session->flashdata('info_message'))){ ?>
		<script type="text/javascript">
			var info_message=$('#info_message').text();
			toaster_msg("info", info_message);
		</script>
<?php } ?>
...
<?php
	if(!empty($this->session->flashdata('popup_alert'))){ 
		$popup_alert = $this->session->flashdata('popup_alert');
		?>
		<script type="text/javascript">
			$(document).ready(function() {
				swal({
		          title: "<?=$popup_alert['title']?>",
		          text: "<?=$popup_alert['text']?>",
		          icon: "<?=$popup_alert['icon']?>",
		          button: "okay",
		          closeOnEsc: false,
...
<?php 
	...
	$this->session->unset_userdata('popup_alert');
?>
...
<script src="<?=base_url()?>assets/js/<?=TEMPLATE_THEME?>/footer.js?v1.0"></script>