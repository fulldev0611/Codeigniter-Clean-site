    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xl-9 col-md-8">
                ...
                <form method="post" enctype="multipart/form-data" autocomplete="off" id="organ_add_service">
...
$(document).ready(function() {
    ...
    // ----------------------------------------------------------------------------
    $('#organ_add_service').bootstrapValidator({
        fields: {
            service_title: {
                validators: {
                    remote: {
                        url: base_url + 'organization/service/check_service_title',
