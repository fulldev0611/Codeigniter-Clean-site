            ...
            <div class="col-xl-9 col-md-8">
                ...
                <ul class="nav nav-tabs menu-tabs">
                    <li class="nav-item active">
                        <a class="nav-link" href="<?php echo base_url() ?>organization-my-services">Active Services</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo base_url() ?>organization-my-services-inactive">Inactive Services</a>
                    </li>
                </ul>
