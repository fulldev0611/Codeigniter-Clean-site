		...
		<div class="row">
			<div class="col">
				<div class="breadcrumb-title">
					<h2> CONTACT <?php echo ($toFlag=='organization_to_admin') ? 'ADMIN' : 'CUSTOMER';?> </h2>
				</div>
			</div>
			<div class="col-auto float-right ml-auto breadcrumb-menu">
				<nav aria-label="breadcrumb" class="page-breadcrumb">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active" aria-current="page"> CONTACT  <?php echo ($toFlag=='organization_to_admin') ? 'ADMIN' : 'CUSTOMER';?> </li>
					</ol>
				</nav>
			</div>
		</div>
				 	...
				 	<div class="col-xl-8 col-lg-8 col-md-6 col-sm-12">
						<div class="contact-blk-content">
							<form method="post" enctype="multipart/form-data" id="contact_form" >
								...
								<?php if(!empty($toFlag) && $toFlag=='organization_to_user' ) { ?>
...
<?php 
	if (!empty($toFlag) && $toFlag=='organization_to_user' ) {
		// code...
		if (count($users) == 0) {
			// code...
			?>
