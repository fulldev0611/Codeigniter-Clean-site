...
<html lang="en">
    <head>    
        ...
        <!-- Custom styles -->
        <link rel="stylesheet" href="/assets/css/video-comm.css">   
    ...
    <body>
        <div class="container-fluid">
            <div class="row">
                <!-- Remote Video -->
                <video id="peerVid" poster="/assets/img/videobg.png" playsinline autoplay></video>
                <!-- Remote Video -->
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <video id="myVid" poster="/assets/img/videobg.png" muted autoplay></video>
                </div>
            </div>
            <!-- Local Video -->
        </div>
        ...
        <!-- custom js -->
        <script src="/assets/js/videojs/config.js?v27"></script>
        <script>wsUrl = '<?php echo $config['WSS_PROTOCAL'] ?>' + '://' + '<?php echo $config['WSS_SERVER'] ?>' +  ':'  + '<?php echo $config['WSS_PORT'] ?>' ;</script>
        <script src="/assets/js/videojs/adapter.js"></script>
        <script src="/assets/js/videojs/comm.js?v11"></script>
        <audio id="callerTone" src="/assets/media/callertone.mp3" loop preload="auto"></audio>
