            ...
            <div class="col-xl-9 col-md-8">
                ...
                <ul class="nav nav-tabs menu-tabs">
                    <li class="nav-item active">
                        <a class="nav-link" href="<?php echo base_url() ?>partner-my-services">Active Services</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo base_url() ?>partner-my-services-inactive">Inactive Services</a>
                    </li>
                </ul>
                                ...
                                <div class="service-widget">
                                    <div class="service-img">
                                        <a href="<?php echo base_url() . 'service-preview/' . str_replace($GLOBALS['specials']['src'], $GLOBALS['specials']['des'], $srows['service_title']) . '?sid=' . md5($srows['id']); ?>">
                                            <?php if (!empty($srows['si_image']) && realpath($srows['si_image'])) { ?>
