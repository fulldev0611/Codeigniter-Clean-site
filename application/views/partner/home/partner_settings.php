        ...
        <div class="tab-content pt-0">
          <div class="tab-pane show active" id="user_profile_settings">
            <div class="widget">
              ...
              <form id="update_user" action="<?php echo base_url() ?>partner/dashboard/update_user" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                  ...
                  <div class="form-group col-xl-6 required">
                    ...
                    <input type="date" class="form-control" name="dob" value="<?php echo !empty($details['dob']) ? date('d-m-Y', strtotime($details['dob'])) : ''; ?>">
                  </div>

                  <div class="form-group col-xl-6 required">
                    <label class="control-label mr-sm-2">Department</label>
                    <select class="form-control" id="department_id" name="department_id">
                      <option value=''>Select Department</option>
                      <?php foreach ($department_list as $row) { ?>
                        <option value='<?php echo $row['id']; ?>' 
                          <?php if (!empty($selected_department)) {
                              echo ($row['id'] == $selected_department) ? 'selected' : '';
                          } ?>><?php echo $row['name']; ?>
                        </option>
                      <?php } ?>
                    </select>
          ...
          <div class="avatar-body">
            ...
            <div class="row avatar-btns">
              <div class="col-md-12">
                ...
                <input type="hidden" id="redirect" name="redirect" value="partner-settings">
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    $('#openfile_profileimg').on('click', function() {
      ...
      $('#redirect').val('partner-settings')
    });
  });
</script>

<script src="<?php echo base_url(); ?>assets/js/partner_settings.js?v1.01"></script>