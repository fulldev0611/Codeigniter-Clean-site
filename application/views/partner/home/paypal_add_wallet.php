    ...
    paypal.Buttons({
      createOrder: function(data, actions) {
        ...
        if($("#wallet_amt").val() > 0)
        {
          ...
          return fetch(base_url+'partner/dashboard/create_paypal_user_wallet', {
              method: 'post',
              headers: {
      ...
      onApprove: function(data, actions) {
        ...
        return fetch(base_url+'partner/dashboard/capture_paypal_user_wallet', {
          method: "post",
          headers: {
            // 'content-type': 'application/json'
            'content-type': 'application/x-www-form-urlencoded'
          ...
          window.location.href = base_url+'partner/dashboard/paypal_add_wallet_success/'+details.id;
        })
        .catch(function(error) {
          console.log("Error getting document:", error);
          hideLoader();
