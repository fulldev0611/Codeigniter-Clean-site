...
?>
				...
				<div class="widget settings-menu">
					<ul role="tablist" class="nav nav-tabs">	
						...
						<li class="nav-item">
		                    <a href="<?php echo base_url()?>partner-security" class="nav-link <?= ($this->uri->segment(1)=="partner-security")?'active':'';?>">
						...
						<li class="nav-item">
							<a href="<?php echo base_url()?>partner-time-clock" class="nav-link <?= ($this->uri->segment(1)=="partner-time-clock")?'active':'';?>">
								<i class="fa fa-clock-o" aria-hidden="true"></i>
								<span>Time Clock</span>
							</a>
						</li>
						<li class="nav-item">
							<a href="<?php echo base_url()?>partner-job-scheduling" class="nav-link <?= ($this->uri->segment(1)=="partner-job-scheduling")?'active':'';?>">
