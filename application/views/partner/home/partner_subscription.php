        ...
        <div class="row">
            ...
            <div class="col-xl-9 col-md-8">
                ...
                if (!empty($my_subscribe['expiry_date_time'])) {
                    if (date('Y-m-d H:i:s', strtotime($my_subscribe['expiry_date_time'])) < date('Y-m-d H:i:s')) {
                        ?>
                ...
                if (!empty($my_subscribe['expiry_date_time'])) {
                    ...
                    if (date('Y-m-d') >= $before_days && date('Y-m-d H:i:s') <= $my_subscribe['expiry_date_time']) {
                        ?>
                        ...
                        <div class="col-xl-4 col-md-6 <?php echo $class; ?>">
                            <div class="card">
                                ...
                                if (!empty($my_subscribe['subscription_id'])) {
                                    ...
                                    if ($list['id'] == $my_subscribe['subscription_id'] && date('Y-m-d H:i:s', strtotime($my_subscribe['expiry_date_time'])) > date('Y-m-d H:i:s')) {
                                        ?>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="plan-det">
                                ...
                                <ul class="row">
                                    <li class="col-sm-4">
                                        <p><span class="text-muted">Started On</span> 
                                            <?php
