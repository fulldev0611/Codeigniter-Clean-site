...
<script  src="<?php echo base_url(); ?>assets/js/admin.js?v1.07"></script>
...
<script src="<?=base_url()?>assets/plugins/ImgUploader/imguploader.bs.js?v1.01"></script>

<script src="<?php echo base_url(); ?>assets/js/jquery.checkboxall-1.0.min.js"></script>
<script src="<?php echo base_url(); ?>assets/js/admin_functions.js?v1.02"></script>
