<div class="page-wrapper">
	<div class="content container-fluid">
        <div class="container">
            <div class="row">
                <div class="col-sm-8">
                    <h4 class="page-title m-b-20 m-t-0">Priority Services Fee</h4>
                </div>
                <div class="col-sm-4 text-right m-b-20">
                    <a href="<?php echo base_url('admin/priority/create'); ?>" class="btn btn-primary add-button"><i class="fa fa-plus"></i></a>
                </div>
            </div>
            <?php
                            ...
                            <tbody>
                                ...
                                ?>
                                            <tr>
                                                ...
                                                <td class="text-right">
                                                    <a href="<?php echo base_url().'admin/priority/edit/' . $_id; ?>" class="btn btn-sm bg-success-light mr-2"><i class="fa fa-edit mr-1"></i> Edit</a>&nbsp;
...
<script type="text/javascript">
    ...
    function delete_item(val) {
        ...
        if(result == true) {
          var url = base_url + 'admin/priority/delete';
          ...
          $.ajax({
            ...
            success: function(res) {
              if(res == 1) {
                window.location = base_url + 'admin/priority';
              } else {
                window.location = base_url + 'admin/priority';
              }
            }
