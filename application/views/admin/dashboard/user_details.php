			...
			<div class="col-lg-8">
				<div class="card">
					<div class="card-body">
						...
						<div class="row">
							<p class="col-sm-3 text-muted text-sm-right mb-0 mb-sm-3">Applying As</p>
							<p class="col-sm-9"><?php echo (empty($user_details['you_are_appling_as']) || !isset(C_APPLINGAS[intval($user_details['you_are_appling_as'])]))?"User":C_APPLINGAS[intval($user_details['you_are_appling_as'])]?></p>
						</div>
						<div class="row">
							<p class="col-sm-3 text-muted text-sm-right mb-0 mb-sm-3">Subscription</p>
							<p class="col-sm-9"><?php echo $user_details['subscription_name'].(isset($user_details['subscription_description'])?" (".$user_details['subscription_description'].")":"")?></p>
						</div>
						<?php 
							if (isset($user_details['subscription_name'])) {
								?>
						<div class="row">
							<p class="col-sm-3 text-muted text-sm-right mb-0 mb-sm-3">Duration</p>
							<p class="col-sm-9"><?php echo date("j F, Y", strtotime($user_details['subscription_date']))." ~ ".date('j F, Y', strtotime($user_details['subscription_expiry_date']))?></p>
						</div>
								<?php
							}
						?>
						...
						<div class="row">
							...
							<p class="col-sm-9"><?php echo $user_details['province']?></p>
						</div>
						<div class="row">
							<p class="col-sm-3 text-muted text-sm-right mb-0 mb-sm-3">City</p>
							<p class="col-sm-9"><?php echo $user_details['city']?></p>
						</div>
						<div class="row">
							<p class="col-sm-3 text-muted text-sm-right mb-0 mb-sm-3">Street Address</p>
							<p class="col-sm-9"><?php echo $user_details['street_address']?></p>
						</div>
						<div class="row">
							<p class="col-sm-3 text-muted text-sm-right mb-0 mb-sm-3">Address</p>
							<p class="col-sm-9"><?=$user_details['house_name']." ".$user_details['house_number']." ".$user_details['street_address']." ".$user_details['city']." ".$user_details['province'] ?></p>
						</div>
						<div class="row">
							<p class="col-sm-3 text-muted text-sm-right mb-0 mb-sm-3">Postal Code</p>
							<p class="col-sm-9"><?php echo $user_details['postal_code']?></p>
						</div>
