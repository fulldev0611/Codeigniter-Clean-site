		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12">
					<h4 class="page-title m-b-20 m-t-0">Edit Transaction Fee</h4> </div>
			</div>
			<div class="row">
				<div class="col-lg-12 col-md-12">
					<div class="card-box">
						<form class="form-horizontal" id="edit_data_form" action="<?php echo base_url($theme .'/transactionfee/edit/'.$id); ?>" method="post" enctype="multipart/form-data">
							...
							<div class="form-group">
								<label class="col-3 control-label">Transaction Fee</label>
									...
									<input type="text" class="form-control col-10" name="transaction_fee" id="transaction_fee" value="<?=$datalist['commission_fee']?>" required> 
