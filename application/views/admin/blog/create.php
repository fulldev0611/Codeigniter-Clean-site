		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12">
					<h4 class="page-title m-b-20 m-t-0">Create New Blog</h4> </div>
			</div>
			<div class="row">
				<div class="col-lg-12 col-md-12">
					<div class="card-box">
						<form class="form-horizontal" id="add_blog" action="<?php echo base_url('admin/blog/create'); ?>" method="POST" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<div class="col-10">
        							...
        							<img src="" style="max-width: 100px; max-height: 50px;" alt="" id="blog_image_show"/>
								</div>
							</div>
							<div class="form-group">
								<label class="col-3 control-label">Content</label>
								<div class="col-12">
									<textarea class="form-control" name="content" id="ck_editor_textarea_id"></textarea>
