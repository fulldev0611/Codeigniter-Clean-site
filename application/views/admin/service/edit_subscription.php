                        ...
                        <form id="editSubscription" method="post">
                            ...
                            <div class="form-group">
								...
								<select class="form-control" name="duration" id="duration">
									...
									<option value="0" <?php echo $subscription['duration']==0 ? "selected":""; ?>>One Hour</option>
                            ...
                            <div class="form-group">
                                <label>Subscription Limit</label>
                                <input class="form-control" type="number" step="0.01" min="1" max="10000000" value="<?php echo $subscription['limit']; ?>" name="limit" id="limit">
                            </div>
                            <?php
