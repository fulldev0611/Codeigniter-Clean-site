						...
						<div class="table-responsive">
							<table class="table table-hover table-center mb-0 service_table">
                                ...
                                <tbody>
									...
									if($user_role==1){
										$aaaaass="return confirm('Are you sure?')";
										$con_delelete='onclick="'.$aaaaass.'"';
									echo'<tr>
                                        <td>'.$i++.'</td>
                                        ...
                                        <td>
											<div '.$tag.'>
												<div class="status-toggle">
													<input '.$attr.' id="status_'.$rows['id'].'" class="check change_Status_Service" onclick="change_Status_Service('.$rows['id'].')" data-id="'.$rows['id'].'" type="checkbox" '.$val.'>
										...
										<td> 
											...
											<a href="'.base_url().'service-details-delete/'.$rows['id'].'" class="btn btn-sm bg-danger-light" '.$con_delelete.'>
                                        ...
                                        <td>
											<div '.$tag.'>
												<div class="status-toggle">
													<input '.$attr.' disabled id="status_'.$rows['id'].'" class="check change_Status_Service" onclick="change_Status_Service('.$rows['id'].')" data-id="'.$rows['id'].' type="checkbox" '.$val.'>
													<label for="status_'.$rows['id'].'" class="checktoggle">checkbox</label>
												</div>
											</div>
                                        </td>
