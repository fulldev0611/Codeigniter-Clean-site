        ...
        <div class="row pricing-box">
            ...
            if (!empty($list)) {
                ...
                foreach ($list as $subscription) {
                    ...
                    $statusTxt = $status == 1?"Active":"Inactive";
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="pricing-card-price">
                                    ...
                                    <p>Status: <span><?=($subscription['status']==1)?"Active":"Inactive"?></span></p>
                                </div>
                                <ul class="pricing-options">
                                    <li><i class="fa fa-check-circle"></i> <?php echo $subscription['fee_description']; ?> expiration</li>
                                </ul>
