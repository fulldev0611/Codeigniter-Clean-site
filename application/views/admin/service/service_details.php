					...
					<div class="card-body">
						<div class="service-header">
							<div class="service-inner">
								...
								<address class="service-location"><i class="fa fa-location-arrow"></i> <?php echo $service_details['service_location']?></address>
								<div class="rating">
									<?php 
			...
			<div class="col-lg-4">
				<div class="card provider-widget clearfix">
					<div class="card-body">
						...
						<!-- <div class="provider-info">
							<p class="mb-1"><i class="fa fa-envelope"></i> <?=$provider['email']?></p>
											<p class="mb-0"><i class="fa fa-phone-alt"></i> xxxxxxxx<?=rand(00,99)?></p>
						</div> -->
							<?php } ?>
					</div>
				</div>
				...
				<div class="sidebar-widget widget">
                    <div class="service-book">
                        <a href="<?php echo base_url() . 'admin/service/edit_service/' . $service_id ?>" class="btn btn-primary btn-block" type="button" id="go_book_service">EDIT SERVICE</a>
                    </div>
                </div>  
			</div>
		</div>
