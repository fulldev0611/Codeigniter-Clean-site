                ...
                <form method="post" enctype="multipart/form-data" autocomplete="off" id="update_service" action="<?php echo base_url() ?>admin/service/update_service">
                    ...
                    <div class="service-fields mb-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control serviceamounttype" title="Select Service Amount Type" name="serviceamounttype" id="serviceamounttype" selected="<?php echo $services['serviceamounttype']; ?>" required>
                                      <?php 
                                        foreach(SERVICE_AMOUNT_TYPES as $key => $value) {
                                          ?>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label>Service Measurement <span class="text-danger">*</span></label>
                                      <select class="form-control" title="Select Service Measurement" name="measurement" id="measurement" selected="<?php echo $services['measurement']; ?>" required>
                                        <?php 
                                            foreach(SERVICE_MEASUREMENTS as $key => $value) {
                                                ?>
                                            <option value="<?=$key?>"><?=$value?></option>
                                                <?php
                                            } 
                    ...
                    <div class="service-fields mb-3">
                        ...
                        <div class="membership-info">
                          <?php if (!empty($serv_offered) && $serv_offered != 'null') {
                                ...
                                for ($i = 0; $i < count($service_image); $i++) { ?>
                                  <li>
                                    <div class=" upload-images" id="<?php echo $service_image[$i]['id']; ?>">
                                      ...
                                      <br>
                                      <a herf="#"  onclick="myFunction(<?php echo $service_image[$i]['id']; ?>)" class="btn btn-danger">Delete</a>
                                    </div>
                                  </li>
                              <?php } ?>
                            </ul>
...
<script>
  ...
  var measurement = <?php echo json_encode($services["measurement"]); ?>;
  $('document').ready(function() {
    console.log(serviceAmountType)
...
<script type="text/javascript">
  function myFunction(id) {
    ...
    $('#' + id).remove();
    $.ajax({
      url: '<?php echo base_url(); ?>admin/service/delete_image',
      data: {'id': id},
