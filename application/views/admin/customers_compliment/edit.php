		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 col-md-12">
					<h4 class="page-title m-b-20 m-t-0">Edit Customer Compliment</h4> </div>
			</div>
			<div class="row">
				<div class="col-lg-12 col-md-12">
					<div class="card-box">
						<form class="form-horizontal" id="edit_data_form" action="<?php echo base_url('admin/'.$model.'/edit/'.$id); ?>" method="POST" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<div class="col-10">
									<input type="text" class="form-control" name="customer_name" id="customer_name" value="<?=$datalist['customer_name']?>" required> 
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-12">
									<textarea class="form-control" name="content" id="ck_editor_textarea_id" required><?=trim($datalist['content'])?></textarea>
