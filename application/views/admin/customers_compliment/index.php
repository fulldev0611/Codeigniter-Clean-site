<div class="page-wrapper">
	<div class="content container-fluid">
        <div class="container">
            <div class="row">
                <div class="col-sm-8">
                    <h4 class="page-title m-b-20 m-t-0">Customers Compliment List</h4>
                </div>
                            ...
                            <tbody>
                                ...
                                ?>
                                            <tr>
                                                ...
                                                <td> <?php echo '<img class="avatar-sm rounded mr-1" src="'.base_url().$customer_image.'"> '.$customer_name ?></td>
                                                <td> <?php echo substr($word, 0, 20);
