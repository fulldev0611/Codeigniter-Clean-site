                    ...
                    <div class="card-body">
                        ...
                        <form action="<?php echo base_url() . 'admin/settings/paypal_edit/' . $list['id']; ?>" method="post">
							...
							<div class="form-group">
								...
								<input class="form-control" type="text" name="client_id" id="client_id" value="<?php if (!empty($list['client_id'])) {
								    echo $list['client_id'];
								} ?>">
							</div>
							<div class="form-group">
								<label>Paypal Secret Key</label>
								<input class="form-control" type="text" name="secret" id="secret" value="<?php if (!empty($list['secret'])) {
								    echo $list['secret'];
								} ?>" >
							</div>
