                                    ...
                                    <div class="card mb-0">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" required="" class="form-control" id="website_name" name="website_name" placeholder="Tazzer" value="<?php if (isset($website_name)) echo $website_name; ?>" pattern="^(?:[A-Za-z]+)(?:[A-Za-z0-9 _]*)$">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="mobile_number" name="landline_number" value="<?php if (isset($landline_number)) echo $landline_number; ?>" required="">
                                            </div>
                                            ...
                                            <!-- changed by MaksimU for fee setting -->
                                            <!-- Instead new added fees in side menu -->
                                            <!-- <div class="form-group">
                                            ...
                                            <!-- @leo: max_service_post_number setting -->
                                            <div class="form-group">
                                                <label>Max Service Post Number</label>
                                                <input type="text" required="" class="form-control" id="max_service_post_number" name="max_service_post_number" placeholder="10" value="<?php if (isset($max_service_post_number)) echo $max_service_post_number; ?>" pattern="^[0-9]+$">
                                            </div>
                                            <div class="form-group">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="host_seller_site" name="host_seller_site" <?php if (isset($host_seller_site) && $host_seller_site == "on") echo "checked=\"\""; ?>>
                                                    <label class="form-check-label" for="host_seller_site">
                                                        Host Seller Site
                                                    </label>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="show_price" name="show_price" <?php if (isset($show_price) && $show_price == "on") echo "checked=\"\""; ?>>
