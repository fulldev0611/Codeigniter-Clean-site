<div class="page-wrapper">
	<div class="content container-fluid">
        <div class="container">
            <div class="row mb-4">
                <div class="col-sm-8">
                    <h4 class="page-title m-b-20 m-t-0">Gift and Points</h4>
                </div>
                <div class="col-sm-4 text-right m-b-20">
                    <a href="<?php echo base_url('admin/gift/create'); ?>" class="btn btn-primary ">Add</a>
                </div>
            </div>
            <?php
                        ...
                        <table class="table table-striped table-actions-bar categories_table">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Title</th>
                                    <th>Shopping Gifts and Points</th>
                            ...
                            <tbody>
                                ...
                                ?>
                                            <tr>
                                                ...
                                                <td> <img style="width:15%" src="<?php echo base_url().$row['img']; ?>" alt="" /></td>
                                                <td class="text-right">
                                                <a href="<?php echo base_url().'admin/gift/edit/' . $_id; ?>" class="btn btn-sm bg-success-light mr-2"><i class="fa fa-edit mr-1"></i> Edit</a>&nbsp;
...
function delete_fee(val) {
    bootbox.confirm("Are you sure want to delete this file ? ", function(result) {
        if (result == true) {
            var BASE_URL = $('#base_url').val();
            var url = BASE_URL + 'admin/gift/delete';
            ...
            $.ajax({
                ...
                success: function(res) {
                  ...
                  if (data == 1) {
                    window.location = BASE_URL + 'admin/gift';
                  } else {
