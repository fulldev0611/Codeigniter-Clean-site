				...
				<div class="card">
					<div class="card-body">
                        <form id="update_category" method="post" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
								<div class="avatar">
									<img class="avatar-img rounded" alt="" src="<?php echo base_url().$categories['image'];?>">
								</div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="file"  name="mobile_icon" id="mobile_icon">
                            </div>
                            <div class="form-group">
								<div class="avatar">
									<img class="avatar-img rounded" alt="" src="<?php echo base_url().$categories['mobile_icon'];?>">
								</div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="mt-4">
								...
								<a href="<?php echo $base_url; ?>delivery-categories"  class="btn btn-link">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
