		...
		<div class="container">
			<div class="row">
				<div class="col-xl-8 offset-xl-2">
					<h4 class="page-title m-b-20 m-t-0">Edit Transaction Fee</h4>
				</div>
			</div>
			<div class="row">
				<div class="col-xl-8 offset-xl-2">
						...
						<div class="card-body">
							<form class="form-horizontal" id="edit_fee" method="POST" enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<input type="date" class="form-control" name="transaction_date" placeholder="0.00" value="<?= isset($feeAry['date']) ? $feeAry['date'] : '' ?>">
								</div>
								
								<div class="form-group">
									<label class=" control-label">Currency</label>
									<input type="text" class="form-control" name="currency" placeholder="" value="<?= isset($feeAry['currency_code']) ? $feeAry['currency_code'] : '' ?>">
								</div>
								
								<div class="form-group">
									<label class=" control-label">Amount</label>
									<input type="text" class="form-control" name="amount" placeholder="0.00" value="<?= isset($feeAry['amount']) ? $feeAry['amount'] : '' ?>">
								</div>
