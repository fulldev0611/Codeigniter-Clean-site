        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-4 text-right m-b-20">
                    <a href="<?php echo base_url($theme . '/commission/create'); ?>" class="btn btn-primary add-button"><i class="fa fa-plus"></i></a>
                </div>
            </div>
            <?php
                            ...
                            <tbody>
                                ...
                                if (!empty($lists)) {
                                    ...
                                    foreach ($lists as $row) {
                                        ...
                                        if ($row['subscription'] == '7') {
                                            $row['subscription_name'] = "Priority Service";
                                        }
...
<script type="text/javascript">
    ...
    function delete_item(val) {
        ...
        if(result == true) {
          var url = base_url + 'admin/commission/delete';
