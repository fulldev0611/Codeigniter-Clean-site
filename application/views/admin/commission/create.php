	...
	<div class="content container-fluid">
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-12 col-md-12">
					<div class="card-box">
						<form class="form-horizontal" id="add_data_form" action="<?php echo base_url($theme .'/commission/create'); ?>" method="POST" enctype="multipart/form-data">
							...
							<div class="form-group">
								...
								<select required="true" class="form-control col-10" name="subscription" id="subscription">
							...
							<div class="form-group">
								<label class="col-3 control-label">Commission Fee</label>
									...
									<input type="text" class="form-control col-10" name="commission_fee" id="commission_fee" value="" required> 
