        ...
        <div class="tab-content pt-0">
          <div class="tab-pane show active" id="user_profile_settings">
            <div class="widget">
              ...
              <form id="update_user" action="<?php echo base_url() ?>staff/dashboard/update_user" method="POST" enctype="multipart/form-data">
          ...
          <div class="avatar-body">
            ...
            <div class="row avatar-btns">
              <div class="col-md-12">
                ...
                <input type="hidden" id="redirect" name="redirect" value="staff-settings">
...
<script src="<?php echo base_url(); ?>assets/js/staff_settings.js?v1.01"></script>