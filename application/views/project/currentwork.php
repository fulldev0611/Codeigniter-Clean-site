                                ...
                                <table class="bids-table">
                                    <thead>
                                        <tr data-border="true" data-expandable-body-compact="true">
                                            ...
                                            <th class="table-header">Awarded Bid</th>
                                            <th class="table-header">Project Awarded</th>
                                            <th class="table-header">Released Milestones</th>
                                    ...
                                    <?php
                                        ...
                                        if (!empty($project_list)) {
                                            foreach ($project_list as $row) {
                                                if(!empty($row['awarded_bid'])) {
                                    ?>  
                                        <tr class="body-row">
                                            <td class="table-content">
                                                <a href="<?php echo base_url().$theme ?>-project-detail/<?=$row['id']?>" class="pro-title-font"><?php echo $row['name']; ?></a> 
                                            </td>
                                            <td class="table-content"><?php echo $row['client']; ?></td>
                                            
                                            <td class="table-content">
                                                <?php echo $row['awarded_bid']; ?> 
                                                <?php echo $row['currency_sign'] ?>
                                            </td>
                                            <td class="table-content"><?php echo $row['project_awarded'] ?> </td>
                                            <td class="table-content">
                                                <?php echo $row['released_milestones'] ?> 
                                                <?php echo $row['currency_sign'] ?> 
                                            </td>
                                            <td class="table-content">
                                                <?php echo $row['state']; ?>
