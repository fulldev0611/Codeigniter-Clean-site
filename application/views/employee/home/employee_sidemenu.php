 ...
 ?>
		...
		<div class="widget settings-menu">
			<ul role="tablist" class="nav nav-tabs">	
				...
				<li class="nav-item">
					<a href="<?php echo base_url()?><?php echo $navigationName?>-project" class="nav-link 
						<?= ($this->uri->segment(1)==$navigationName."-project-detail" 
							|| $this->uri->segment(1)==$navigationName."-project-proposals")?'active':'';?>">
						<i class="fa fa-calendar-o"></i>
						<span>Projects</span>
					</a>
				</li>
