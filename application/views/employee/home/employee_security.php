		...
		<div class="row">
            ...
            <div class="col-xl-9 col-md-8">
				<div class="tab-content pt-0">
					<div class="tab-pane show active" id="employee_security_settings" >
						<div class="widget">
							<h4 class="widget-title">Security Settings</h4>
							<form id="update_employee" action="<?php echo base_url()?><?php echo $navigationName?>-security" method="POST" enctype="multipart/form-data">
