...
<html>
    <?php
    $this->website_name = 'tazzerclean';
    $this->website_logo_front = 'assets/img/'.TEMPLATE_THEME.'/logo.png';
...
setTimeout(ldinsp, 0);
        ...
        <link rel="stylesheet" href="<?=base_url()?>assets/css/<?=TEMPLATE_THEME?>/style.css?v1.02">
