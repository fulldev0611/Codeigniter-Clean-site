	                           ...
	                           <div class="form-group col-md-6 mt-3">
								...
								<div class="form-group col-md-6 mt-3">
									...
									<select required="true" class="form-control" name="you_are_appling_as" id="are_appling_as">
										...
										<option value="10">Organization</option> 
										<!-- value:11 is staff(added by Organization)  -->
								...
								<div class="form-group">
									<div class="custom-control custom-control-xs custom-checkbox">
										...
										<label class="custom-control-label" for="agree_checkbox_user">I agree to <?=$this->website_name?></label> <a tabindex="-1" href="javascript:void(0);">Privacy Policy</a> &amp; <a tabindex="-1" href="javascript:void(0);"> Terms.</a>
									</div>
								</div>
								<div class="form-group">
				      ...
				      <div class="contactdet">
				        <ul>
				          <li class="color-grey">
							...
							<p>Tazzerclean provides high quality, professional and on-demand, services that are fully trusted and convenient with a highly professional team.<!--  We will bring together the entire Industrial Services in one place. --></p>
					...
					<div class="col-md-6 col-lg-6">
						...
						<div class="copyright-menu">
							<ul class="policy-menu">
								...
								<li><a href="<?php echo base_url()?>terms-conditions">Security</a></li>
...
<?php if($page=='home' || $module=='service_categories' || $module=="service") { ?>
	...
	<script src="<?php echo base_url();?>assets/js/place.js?v1.08"></script>
<?php } ?>
...
<script src="<?php echo base_url();?>assets/js/functions.js?v1.06"></script>
...
<script src="<?php echo base_url();?>assets/js/script.js?v1.02"></script>

<!-- External js-->
<?php if($this->uri->segment(1)=="user-chat"){ ?>
	<script src="<?php echo $base_url; ?>assets/js/user_chats.js?v1.05"></script>
<?php }?>
...
<?php if($this->uri->segment(1)=="all-services" ||$this->uri->segment(1)=="search"){ ?>
	<script src="<?php echo base_url(); ?>assets/js/service_search.js?v1.04"></script>
<?php }?>
...
<?php if($this->uri->segment(1)=="organization-subscription"){ ?>
	<script src="<?php echo base_url(); ?>assets/js/organization_subscription.js?v1.05"></script>
<?php }?>
...
<?php if($this->uri->segment(1)=="partner-subscription"){ ?>
	<script src="<?php echo base_url(); ?>assets/js/partner_subscription.js?v1.05"></script>
<?php }?>
<!-- ========================= #end maksimU ================================ -->
<!---External js end-->
