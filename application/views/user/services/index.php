...
<div class="search-by-category row">
    <div class="col-lg-12">
        <div class="category-search-link">
            <a href="<?php echo base_url(); ?>service-search-by-category">
                ...
                <div class="search-box">
                    <div class="search-input line">
                        ...
                        <div class="form-group mb-0">
                            <input type="text" id="common_search" value="<?php if (isset($_POST["common_search"]) && !empty($_POST["common_search"])) echo $_POST["common_search"]; ?>" class="form-control common_search" placeholder="Please type what you want here" />
                        </div>
                    </div>
                    <div class="search-input">
                        <i class="fa fa-location-arrow bficon"></i>
                        <div class="form-group mb-0">
                            <input class="form-control" type="text" id="service_location" value="<?php if (isset($_POST["user_address"]) && !empty($_POST["user_address"])) echo $_POST["user_address"]; ?>" placeholder="Postcode / Zipcode" name="user_address" >
                        ...
                        <form id="search_form">
                            ...
                            <div class="filter-widget">
                                ...
                                <!-- <div class="filter-list">
                                    ...
                                    <input class="form-control" type="text" id="service_location" value="<?php if (isset($_POST["user_address"]) && !empty($_POST["user_address"])) echo $_POST["user_address"]; ?>" placeholder="Enter Postcode or Zipcode" name="user_address" >
                                    <input type="hidden" value="<?php if (isset($_POST["user_latitude"]) && !empty($_POST["user_latitude"])) echo $_POST["user_latitude"]; ?>" id="service_latitude">
                                    <input type="hidden" value="<?php if (isset($_POST["user_longitude"]) && !empty($_POST["user_longitude"])) echo $_POST["user_longitude"]; ?>" id="service_longitude">
                                </div> -->
                                <div class="filter-list">
                                ...
                                <div class="filter-list">
                                    ...
                                    <div class="price-ranges">
                                        <?php echo $currency; ?><span class="from d-inline-block" id="min_price"><?php echo $min_price['service_amount'] ?></span> -
                                        <?php echo $currency; ?><span class="to d-inline-block" id="max_price"><?php echo $max_price['service_amount'] ?></span>
                                    </div>  
                ...
                <div class="row align-items-center mb-4">
                    ...
                    <div class="col-md-6 col-auto">
                        <div class="view-icons ">
                            <a href="javascript:void(0);" class="grid-view active"><i class="fa fa-th-large"></i></a>
                        </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="service-widget">
                                        <div class="service-img">
                                            <a href="<?php echo base_url() . 'service-preview/' . str_replace($GLOBALS['specials']['src'], $GLOBALS['specials']['des'], strtolower($srows['service_title'])) . '?sid=' . md5($srows['id']); ?>">
                                            ...
                                            <div class="item-info">
                                                ...
                                                <div class="cate-list"> <a class="bg-yellow" href="<?php echo base_url() . 'search/' . str_replace($GLOBALS['specials']['src'], $GLOBALS['specials']['des'], strtolower($srows['category_name'])); ?>"><?php echo ucfirst($srows['category_name']); ?></a></div>
                                            </div>
                                        </div>
                                        <div class="service-content">
                                            <h3 class="title">
                                                ...
                                                $cat = str_replace($GLOBALS['specials']['src'], $GLOBALS['specials']['des'], strtolower($srows['service_title']));
                                                 ...
                                                 echo base_url() . 'service-preview/' . $cat . '?sid=' . md5($srows['id']); ?>"><?php echo ucfirst($srows['service_title']);
                                                  ?></a>
                                            </h3>
                                            <div class="rating">
                                                <?php
...
<link rel="stylesheet" href="<?php echo base_url();?>assets/css/services/index.css?v1.0">
<!-- <script src="<?php echo base_url(); ?>assets/js/services/index.js"></script> -->