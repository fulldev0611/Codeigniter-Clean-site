                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6 mt-3">
                            ...
                            <select name="countryCode" id="country_code" class="form-control countryCode final_country_code">
                                ...
                                <option <?=$select;?> data-countryCode="<?=$country['country_code'];?>" value="<?=$country['country_code'];?>">
...
<link rel="stylesheet" href="<?php echo base_url();?>assets/css/home/join_us.css?v1.0">
<script type="text/javascript">
</script>
<script src="<?=base_url()?>assets/js/join_us.js?v1.02"></script>