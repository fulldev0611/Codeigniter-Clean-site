    ...
    <div class="panel-style">
        ...
        <div class="widget settings-menu">
            <ul role="tablist" class="nav nav-tabs">
                ...
                <li class="nav-item">
                    <a href="<?php echo base_url()?>user-security" class="nav-link <?= ($this->uri->segment(1)=="user-security")?'active':'';?>">
                ...
                <?php 
                    if($this->session->userdata('you_are_appling_as') == C_YOUARE_BUSINESS) {
                ?>
                <li class="nav-item">
                    <a href="<?php echo base_url()?>business-subscription" class="nav-link <?= ($this->uri->segment(1)=="business-subscription")?'active':'';?>">
                        <i class="fa fa-calendar"></i>
                ...
                <li class="nav-item">
                    <a href="<?php echo base_url()?>affliation-referral" class="nav-link <?= ($this->uri->segment(1)=="affliation-referral")?'active':'';?>">
                        <i class="fa fa-hashtag"></i>
                        <span>Affliation Referral</span>
                    </a>
                </li>
                <!-- <?php 
                    if($this->session->userdata('you_are_appling_as') == C_YOUARE_SHOP || $this->session->userdata('you_are_appling_as') == C_YOUARE_SUBCONTRACTOR) {
                ?>
                <li class="nav-item">
                    <a href="<?php echo base_url()?>user-time-clock" class="nav-link <?= ($this->uri->segment(1)=="user-time-clock")?'active':'';?>">
                        <i class="fa fa-clock-o" aria-hidden="true"></i>
                        <span>Time Clock</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="<?php echo base_url()?>user-job-scheduling" class="nav-link <?= ($this->uri->segment(1)=="user-job-scheduling")?'active':'';?>">
