				...
				<div class="tab-content pt-0">
					<div class="tab-pane show active" id="user_profile_settings" >
						<div class="widget">
							...
							<form id="update_user_pwd" action="<?php echo base_url()?>user/dashboard/update_user_password" method="POST" onsubmit="return updatepassword();" enctype="multipart/form-data">
...
function checkcurpwd()
{
	...
	$.ajax({
		type: "POST",
		url: base_url+"user/dashboard/checkuserpwd",
...
function updatepassword()
{
	...
	$.ajax({
		type: "POST",
		url: base_url+"user/dashboard/userupdatepassword",
