...
//                                           print_r($service_amount1);exit;
                                    ...
                                    <div class="booking-action">
                                        ...
                                        <?php if ($bookings['status'] == 2) { ?>
                                            ...
                                            <a href="javascript:void(1);" class="btn btn-sm bg-danger-light myCancel" data-toggle="modal" data-target="#myCancel" data-id="<?php echo $bookings['id'] ?>" data-providerid="<?php echo $bookings['provider_id'] ?>" data-userid="<?php echo $bookings['user_id'] ?>" data-serviceid="<?php echo $bookings['service_id'] ?>">
                                        ...
                                        <?php } elseif ($bookings['status'] == 3) { ?>
                                            ...
                                            <a href="javascript:void(1);" class="btn btn-sm bg-success-light update_user_booking_status" data-id="<?= $bookings['id']; ?>" data-status="6" data-rowid="<?= $pending; ?>" data-review="2" >
                                                <i class="fa fa-check"></i>Compete Request Accept
                                            </a>
                                        ...
                                        <span class="badge badge-pill badge-prof bg-primary text-light
                                        "><?php echo $bookings['start_time']; ?></span>
                                            <a href="javascript:void(1);" class="btn btn-sm bg-danger-light myCancel" data-toggle="modal" data-target="#myCancel" data-id="<?php echo $bookings['id'] ?>" data-providerid="<?php echo $bookings['provider_id'] ?>" data-userid="<?php echo $bookings['user_id'] ?>" data-serviceid="<?php echo $bookings['service_id'] ?>"> 
                                                <i class="fa fa-times"></i> <?php echo (!empty($user_language[$user_selected]['lg_cancel_service'])) ? $user_language[$user_selected]['lg_cancel_service'] : $default_language['en']['lg_cancel_service']; ?>
                                            </a>
                                        <?php } ?>
