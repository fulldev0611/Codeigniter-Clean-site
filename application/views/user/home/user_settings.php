							...
							<form id="update_user" action="<?php echo base_url()?>user/dashboard/update_user" method="POST" enctype="multipart/form-data">
									...
									<div class="form-group col-xl-12">
										<div class="media align-items-center mb-3">
											...
											<div class="media-body">
												<h5 class="mb-0"><?php echo $get_details['name'].(!empty($get_details['l_name'])?" ".$get_details['l_name']:"")?></h5>
								...
								<div class="row">
									<div class="form-group col-xl-6">
										...
										<input class="form-control" type="text" value="<?php echo $get_details['name'].(!empty($get_details['l_name'])?" ".$get_details['l_name']:"") ?>" readonly>
									</div>
									<div class="form-group col-xl-6">
									...
									<div class="form-group col-xl-6 required">
										...
										<input type="text" class="form-control" name="pincode" value="<?php if(!empty($get_details['postal_code'])){echo $get_details['postal_code'];} ?>" >
									</div>	
									<div class="form-group col-xl-12">
...
<script src="<?php echo base_url(); ?>assets/js/user_settings.js?v1.05"></script>