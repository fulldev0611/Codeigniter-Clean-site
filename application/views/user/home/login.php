        ...
        <div data-v-9cf711f2="" class="card-right" style="background-image: url(&quot;<?=base_url();?>assets/img/<?=TEMPLATE_THEME?>/logo.png&quot;),url(&quot;<?=base_url();?>assets/img/login/Path1.png&quot;);">
            <div data-v-9cf711f2="" class="v-card__title">
                <div data-v-9cf711f2="" class="row mt-15 align-left justify-left" style="padding: 10px 8%;">
                    <h2 data-v-9cf711f2="" class="card-title">Account Login</h2></div>
            </div>
            <br data-v-9cf711f2="">
            <div class="error-box">
                <span id="error"></span>
            ...
            <div class="login-card-container">
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <input class="form-control login_email" type="text" name="login_email" id="login_email" placeholder="Enter Email" >
                        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <input type="password" class="form-control form-control-lg" autocomplete="off"  placeholder="Enter Password" name="login_password" id='login_password'>
                        </div>
                    </div>
                </div>
                <p class="user_forgot_pwd">Forgot Password? <a href="javascript:void(0)"  id="user_forgot_pwd"> Click to Get Link</a></p>
                <span id="info_res"></span>
                <button class="login-btn" id="emaillogin_finals" type="submit">Login</button>
