...
<footer class="footer">
	<section class="subscribe">
	    <div class="container">
	        <div class="row">
	            <div class="col-lg-7 col-md-9 col-sm-10 email-subscription">
	                <h2>Subscribe to our Newsletter</h2>
	                <div class="input-group">
	                     <input type="email" class="form-control" id="email-sub" placeholder="Enter your email">
	                     <span class="input-group-btn">
	                     	<button class="btn btn-theme mail-subscribe" type="submit"></button>
	                     </span>
	                </div>
	                <p class="sub-msg"></p>
	            </div>
				          ...
				          <li class="color-grey">
				            <p><a href="<?php echo base_url();?>">
								<!-- upgraded by maksimU for whitelist labeld -->
									<!-- <img alt="Logo" class="img-fluid" src="<?php echo base_url(); ?>assets/img/logo-icon-old.png" /> -->
									<img src="<?php echo base_url() . $this->website_logo_footer;?>" class="img-fluid footer-logo" alt="Logo" />
								<!-- maksimU end -->
								
								</a></p>
							<p>Tazzer Group provides high quality, professional and on-demand services that are fully trusted and convenient with a highly professional team.<!--  We will bring together the entire Industrial Services in one place. --></p>
				        ...
				        <ul>
				          ...
				          <li class="color-grey">
							<ul>
								...
								<li><a href="<?php echo base_url(); ?>job/jobmatch">Job List</a></li>
								<li><a href="<?php echo base_url('b2b/Reqforquote'); ?>">REQUEST FOR QUOTE </a></li>
			...
			$(document).ready(function() {
				swal({
		          ...
		          closeOnClickOutside: false
		        	...
		        	// 10/14/2021 send notification email to incompleted profile
		        	var params = {
		        		csrf_token_name: $("#csrf_token").val()
		        	}
		        	$.post("<?=base_url()?>home/send_incomplete_profile_notification", params, function(response) {
		        		var result = JSON.parse(response);
		        		if (result.response == "failed") {
		        			toaster_msg("error", result.msg)
		        		}
		        	});
		        });
			});
