...
<div class="main-wrapper">
    <header class="header sticktop" style="background: transparent;">
        <nav class="navbar navbar-expand-md navbar-light" id="tazzer-top-navbar">
            ...
            <div class="collapse navbar-collapse" id="collapseTopNavbar">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item">
                      <a href="javascript:void();" class="nav-link"><i class="fa fa-facebook-official"></i></a>
                    </li>
                    <li class="nav-item">
                      <a href="javascript:void();" class="nav-link"><i class="fa fa-instagram"></i></a>
                    </li>
                    <li class="nav-item">
                      <a href="javascript:void();" class="nav-link"><i class="fa fa-snapchat"></i></a>
                    </li>
                    <li class="nav-item">
                      <a href="javascript:void();" class="nav-link"><i class="fa fa-flickr"></i></a>
                    </li>
                    <li class="nav-item">
                      <a href="javascript:void();" class="nav-link"><i class="fa fa-twitter"></i></a>
                    </li>
                    <li class="nav-item">
                      <a href="javascript:void();" class="nav-link"><i class="fa fa-linkedin"></i></a>
                    </li>
                </ul>
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="javascript:void(0);" data-toggle="modal" data-target="#modal-wizard1">Register</a>
                    </li>
                    <li class="nav-item">
                ...
                <ul class="navbar-nav">
                    ...
                    <?php
                        ...
                        if (($this->session->userdata('id') != '') && ($this->session->userdata('usertype') == 'user')) {   ?>
                                <li class="nav-item desc-list">
                                    <a href="<?php echo base_url(); ?>post-a-jobs" class="nav-link header-login post-jobs" id="post-jobs"><i class="fa fa-plus-circle mr-1"></i> <span>Post A Job </span></a>
                                </li>
                                <?php
                        }  ?>
        ...
        <nav class="navbar navbar-expand-lg header-nav">
            ...
            <?php 
                if ($this->session->userdata('id') == '') { ?>
                    ...
                    <li><a class="btn tazzer-button" href="javascript:void(0);"  data-toggle="modal" data-target="#myModal"><?php echo (!empty($user_language[$user_selected]['lg_become_user'])) ? $user_language[$user_selected]['lg_become_user'] : $default_language['en']['lg_become_user']; ?></a></li>

                    <!-- <li><a class="btn tazzer-button" href="javascript:void(0);"  data-toggle="modal" data-target="#">BECOME A SELLER</a></li> -->
