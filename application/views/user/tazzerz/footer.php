				  ...
				  <div class="footer-widget footer-menu">
				    ...
				    <div class="about">
				      <div class="contactdet">
				        <ul>
				          <li class="color-grey">
				            <p><a href="<?php echo base_url();?>"><img alt="Logo" class="img-fluid" src="<?php echo base_url(); ?>assets/img/logo-icon.png" /></a></p>
							<p>Tazzerz provides high quality, professional and on-demand, services that are fully trusted and convenient with a highly professional team. We will bring together the entire Industrial Services in one place.</p>
				      ...
				      <div class="contactdet">
				        <ul>
				          <li class="color-grey">
							...
							<p><span style="font-size:16px"><img src="<?php echo base_url(); ?>assets/img/call.3c7e5ae4.svg">&nbsp; &nbsp;  (+44)079 6124 2587 </span></p>
...
<?php if($module=='home') { ?>
	...
	<script src="<?php echo base_url();?>assets/js/place.js?v1.06"></script>
<?php } ?>
...
<?php if($this->uri->segment(1)=="user-chat"){ ?>
	<script src="<?php echo $base_url; ?>assets/js/user_chats.js?v1.03"></script>
<?php }?>
