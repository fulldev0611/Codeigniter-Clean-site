<?php
/**
 * @author Leo: Clearance And Rubbish Removal Service Landing Page
*/
?>
...
<section class="about-section section">
    <div class="about-block row">
        ...
        <div class="about-block-right col-xl-7 col-lg-7 col-md-8 col-sm-12">
            <div class="header-1">
                <span>House Clearance & Rubbish Removal Services</span>
            </div>
            <div class="header-2">
...
<section class="how-it-works-section section" style="background-image: url(/assets/img/<?=$page?>/bg-bottom.png);">
    <div class="row">
        <div class="col-12 how-it-works-header section-header">
            ...
            <p>We have done all the leg work for you to keep you safe at all times <br>and you can shop confidently</p>
        </div>
    </div>
...
<section class="offer-section section">
    <div class="offer-section-header">
        <div class="header-1">
            <span>Clearance & Rubbish Removal</span>
        </div>
        <div class="header-2">
    ...
    <div class="offer-block row">
        ...
        <div class="offer-item col-lg-6 col-md-6 col-sm-12">
            ...
            <div class="offer-content">
                <span>
                    <h4 class="offer-title">Factory and Site Clearance</h4>
                    <text class="offer-desc"></text>
                </span>
            </div>
        </div>
