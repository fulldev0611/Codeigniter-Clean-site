<?php
/**
 * @author Leo: Domestic Helpers Services Landing Page
*/
?>
...
<section class="about-section section">
    <div class="about-block row">
        <div class="about-block-left col-xl-7 col-lg-7 col-md-8 col-sm-12">
            <div class="header-1">
                <span>The Right Choice for Quality for <br><span class="highlight">Domestic Helpers by Tazzer Group</span></span>
            </div>
            <div class="header-2">
                <span>We are dedicated to providing the highest Domestic Helpers</span>
            </div>
...
<section class="service-section section">
    <div class="service-block row">
        ...
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
            <div class="service-box">
                <div class="service-box-image" link="<?php echo base_url();?>">
                    <img alt="Industrial" src="<?=base_url()?>assets/img/<?=$page?>/industrial_new.png" transition="scale-transition">
                </div>
                <div class="title-mask"></div>
                <div class="service-box-title">
            ...
            <div class="contact-us-text">  
                <span>
                    <h3 class="contact-us-title">
                        Contact us for Domestic Helpers Service provider today!
                    </h3>
...
<section class="offer-section section">
    ...
    <div class="feature-box row">
        <div class="feature-block-left col-xl-8 col-lg-8 col-md-8 col-sm-12">
            <div class="feature-list row">
                <div class="feature-item col-lg-6 col-md-6 col-sm-12">
                    <div class="feature-img">
                        <img src="<?=base_url()?>assets/img/<?=$page?>/washing-machine.png">
                    </div>
                    <div class="feature-content">
                        <span>
                            <h4 class="feature-title">Laundry wash & dry</h4>
                ...
                <div class="feature-item col-lg-6 col-md-6 col-sm-12">
                    <div class="feature-img">
                        <img src="<?=base_url()?>assets/img/<?=$page?>/iron.png">
                    </div>
                    <div class="feature-content">
                        <span>
                            <h4 class="feature-title">Ironing Service</h4>
                            <text class="feature-desc"></text>
                        </span>
                    </div>
                </div>
                <div class="feature-item col-lg-6 col-md-6 col-sm-12">
                    <div class="feature-img">
                        <img src="<?=base_url()?>assets/img/<?=$page?>/cleaning.png">
                    </div>
                    <div class="feature-content">
                        <span>
                ...
                <div class="feature-item col-lg-6 col-md-6 col-sm-12">
                    <div class="feature-img">
                        <img src="<?=base_url()?>assets/img/<?=$page?>/meal.png">
                    </div>
                    <div class="feature-content">
                        <span>
                            <h4 class="feature-title">Meals</h4>
                            <text class="feature-desc"></text>
                        </span>
                    </div>
                </div>
                <div class="feature-item col-lg-6 col-md-6 col-sm-12">
                    <div class="feature-img">
                        <img src="<?=base_url()?>assets/img/<?=$page?>/bill.png">
                    </div>
                    <div class="feature-content">
                        <span>
                            <h4 class="feature-title">Bills Payment</h4>
                            <text class="feature-desc"></text>
                        </span>
                    </div>
                </div>
                <div class="feature-item col-lg-6 col-md-6 col-sm-12">
                    <div class="feature-img">
                        <img src="<?=base_url()?>assets/img/<?=$page?>/veterinarian.png">
                    </div>
                    <div class="feature-content">
                        <span>
                            <h4 class="feature-title">Pet care</h4>
                            <text class="feature-desc"></text>
                        </span>
                    </div>
                </div>
                <div class="feature-item col-lg-6 col-md-6 col-sm-12">
                    ...
                    <div class="feature-content">
                        <span>
                            <h4 class="feature-title">School pick up & drop off</h4>
                            <text class="feature-desc"></text>
                        </span>
                    </div>
                </div>
                <div class="feature-item col-lg-6 col-md-6 col-sm-12">
                    ...
                    <div class="feature-content">
                        <span>
                            <h4 class="feature-title">Live in Housekeeper</h4>
                            <text class="feature-desc"></text>
                        </span>
                    </div>
                </div>
        ...
        <div class="feature-block-right col-xl-4 col-lg-4 col-md-4 col-sm-4">
            <img class="offer-block-image img-fluid" src="<?=base_url();?>assets/img/<?=$page?>/professioal.png?v1.0">
        </div>
    </div>
</section>
...
<section class="choose-section section">
    <div class="choose-block row">
        <div class="choose-block-left col-xl-5 col-lg-5 col-md-4 col-sm-4">
            ...
            <img class="choose-block-image img-fluid" src="<?=base_url();?>assets/img/<?=$page?>/growth.png">
        </div>
        <div class="choose-block-right col-xl-7 col-lg-7 col-md-8 col-sm-12">
            <div class="header-text">Why Choose Us</div>
            <div class="header-1">
                <span>Let's Check Your Growth! with Tazzer Group <span class="highlight">Domestic Helpers</span></span>
            </div>
            <div class="header-2">
...
<section class="join-section section" style="background-image: url(/assets/img/<?=$page?>/join-us.png);">
    ...
    <div class="join-block">
        <div class="join-text">
            <div class="header-1">
                Professional Domestic <br> Helpers Services
            </div>
            <div class="header-2">
...
<section class="exp-section section">
    ...
    <div class="exp-block row" style="background-image:url(/assets/img/<?=$page?>/solution.png);">
