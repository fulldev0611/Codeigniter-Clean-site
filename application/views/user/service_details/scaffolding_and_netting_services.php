<?php
/**
 * @author Leo: Scaffolding And Netting Services Landing Page
*/
?>
...
<section class="about-section section">
    <div class="about-block row">
        <div class="about-block-left col-xl-5 col-lg-5 col-md-4 col-sm-4">
            ...
            <img class="about-block-image img-fluid" src="<?=base_url();?>assets/img/<?=$page?>/about.png?v1.0">
        </div>
        <div class="about-block-right col-xl-7 col-lg-7 col-md-8 col-sm-12">
            <div class="header-text">
                <span>The Tazzer Group</span>
            </div>
            <div class="header-1">
                <span>We Provide <span class="highlight">Scaffolding & Netting</span></span>
            </div>
            <div class="header-2">
                <span>We are dedicated to providing the highest Scaffolding and Netting Services.</span>
            </div>
            ...
            <div class="contact-us-text">  
                <span>
                    <h3 class="contact-us-title">
                        Contact us for Scaffolding & Netting Service provider today!
                    </h3>
...
<section class="offer-section section">
    ...
    <div class="feature-box row">
        <div class="feature-block-left col-xl-7 col-lg-7 col-md-7 col-sm-12">
            <div class="feature-list">
                <div class="feature-item">
                    <div class="feature-img">
                        <img src="<?=base_url()?>assets/img/<?=$page?>/tower-block.png">
                    </div>
                    <div class="feature-content">
                        <span>
                            <h4 class="feature-title">Alloy Towers Scaffolding Domestic & Commercial</h4>
                ...
                <div class="feature-item">
                    <div class="feature-img">
                        <img src="<?=base_url()?>assets/img/<?=$page?>/scaffolding.png">
                    </div>
                    <div class="feature-content">
                        <span>
                            <h4 class="feature-title">Layer Scaffolding Domestic & Commercial</h4>
                            <text class="feature-desc"></text>
                        </span>
                    </div>
                </div>
                <div class="feature-item">
                    <div class="feature-img">
                        <img src="<?=base_url()?>assets/img/<?=$page?>/net.png">
                    </div>
                    <div class="feature-content">
                        <span>
                            <h4 class="feature-title">Scaffolding Netting Domestic & Commercial</h4>
                            <text class="feature-desc"></text>
                        </span>
                    </div>
                </div>
                <div class="feature-item">
                    <div class="feature-img">
                        <img src="<?=base_url()?>assets/img/<?=$page?>/maintenance.png">
                    </div>
                    <div class="feature-content">
                        <span>
                            <h4 class="feature-title">Scaffolding Hire</h4>
                            <text class="feature-desc"></text>
                        </span>
                    </div>
                </div>
                <div class="feature-item">
                    <div class="feature-img">
                        <img src="<?=base_url()?>assets/img/<?=$page?>/scaffolding1.png">
                    </div>
                    <div class="feature-content">
                        <span>
                            <h4 class="feature-title">Scaffolding tube & Fitting</h4>
                            <text class="feature-desc"></text>
                        </span>
                    </div>
                </div>
        ...
        <div class="feature-block-right col-xl-5 col-lg-5 col-md-5 col-sm-5">
...
<section class="choose-section section">
    <div class="choose-block row">
        ...
        <div class="choose-block-right col-xl-7 col-lg-7 col-md-8 col-sm-12">
            ...
            <div class="header-2">
                <span>Let's Check Your Growth! with <br>Tazzer Group <span class="highlight">Scaffolding & Netting</span></span>
            </div>
            <div class="header-2">
...
<section class="join-section section" style="background-image: url(/assets/img/<?=$page?>/join-us.png);">
    ...
    <div class="join-block">
        <div class="join-text">
            <div class="header-1">
                Professional Scaffolding & Netting
            </div>
            <div class="header-2">
...
<section class="exp-section section">
    <div class="section-header">
        ...
        <div class="header-2">
            <span>Smart and Effective <span class="highlight">Solution Provide</span></span>
        </div>
    </div>
    <div class="exp-block row">
        <div class="exp-block-left col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
            <img class="exp-block-image img-fluid" src="/assets/img/<?=$page?>/solution.png?v1.0" alt="">
        </div>
        <div class="exp-block-right col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
            <div class="exp-header">
                Get Satisfied with the services we provide A to Z in Scaffolding & Netting Services.
            </div>
