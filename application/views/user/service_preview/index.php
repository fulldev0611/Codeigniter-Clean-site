                ...
                <div class="service-view">
                    <div class="service-header">
                        ...
                        <div class="service-cate">
                            <a href="<?php echo base_url(); ?>search/<?php echo str_replace($GLOBALS['specials']['src'], $GLOBALS['specials']['des'], $service['category_name']); ?>"><?php echo ucfirst($service['category_name']); ?></a>
                        </div>
                    </div>
                        ...
                        foreach ($popular_service as $key => $serv) {
                            ...
                            <div class="service-widget">
                                <div class="service-img">
                                    <a href="<?php echo base_url() . 'service-preview/' . str_replace($GLOBALS['specials']['src'], $GLOBALS['specials']['des'], strtolower($serv['service_title'])) . '?sid=' . md5($serv['id']); ?>">
                                    ...
                                    <div class="item-info">
                                        ...
                                        <div class="cate-list"> <a class="bg-yellow" href="<?php echo base_url(); ?>search/<?php echo str_replace($GLOBALS['specials']['src'], $GLOBALS['specials']['des'], $serv['category_name']); ?>"><?= ucfirst($serv['category_name']); ?></a></div>
                                    </div>
                                </div>
                                <div class="service-content">
                                    <h3 class="title">
                                        <a href="<?php echo base_url() . 'service-preview/' . str_replace($GLOBALS['specials']['src'], $GLOBALS['specials']['des'], $serv['service_title']) . '?sid=' . md5($serv['id']); ?>"><?= $serv['service_title']; ?></a>
                                    </h3>
                                    <div class="rating">
                                        <?php
                                        $rating = $serv['rating']?$serv['rating']:0;
                                    ...
                                    <div class="user-info">
                                        <div class="row">
                                            ...
                                            <span class="col ser-location" title="Address"><span><?php echo (!empty($user_language[$user_selected]['lg_address'])) ? $user_language[$user_selected]['lg_address'] : $default_language['en']['lg_address']; ?></span> <i class="fa fa-map-marker-alt ml-1"></i></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-lg-4 theiaStickySidebar">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">
                            <?php 
                                ...
                                if ($service["user_type"] != "provider") {
                                    echo C_APPLINGAS[intval($provider['you_are_appling_as'])];
                                }
                                else {
                                    echo (!empty($user_language[$user_selected]['lg_Service_Provider'])) ? $user_language[$user_selected]['lg_Service_Provider'] : $default_language['en']['lg_Service_Provider']; 
                                }
                            ?>
                        </h5>
                        ...
                        <div class="about-author">
                            ...
                            <div class="provider-details">
                                <a href="javascript:void(0);" class="ser-provider-name"><?= !empty($provider['name']) ? $provider['name'].($provider['l_name']?" ".$provider['l_name']:"") : '-'; ?></a>
                                <p class="last-seen"> 
                                    <?php if ($provider_online['is_online'] == 2) { ?>
                                        <i class="fa fa-circle"></i> Last seen: &nbsp;
                                ...
                                <?php } elseif ($provider_online['is_online'] == 1) { ?>
                                    <i class="fa fa-circle online"></i> Online</p>
                                <?php } ?>
                ...
                <div class="card provider-widget clearfix">
                    <div class="card-body">
                        ...
                        <div class="seller-website-link">
                            <a href="<?=$provider['site_link']?>" target="_blank"><?=$provider['site_link']?></a>
                        </div>
                    </div>
                </div>
                        <?php
                ...
                <div class="sidebar-widget widget">
                    ...
                    <div class="service-amount">
                        <span>Price: <?php echo currency_conversion($user_currency_code) . $service_amount; if($service['serviceamounttype'] == "Hourly") { ?> /hr <?php } ?></span>
                    </div>
                            <?php
                        }
                    ?>
                    <div class="service-book">
                        ...
                        # added by maksimU : for employee flag
                        $isEmployee = $this->session->userdata('employee_status')=='yes';
                        # end 
                        
                        if (!empty($userId)) {
                            $applyingAs = $this->session->userdata("you_are_appling_as");
                            if (!empty($usertype) && $usertype == 'user' && !($service['user_type'] == "user" && $service["user_id"] == $userId)) {
                                ...
                                if (isset($wallet_info->wallet_amt)
                                    && ! $isEmployee        # <--- added by maxim : for Employee no view [Book service]
                                    ) {
