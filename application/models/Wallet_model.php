...
class Wallet_model extends CI_Model
{
    ...
    public function get_wallet_history()
    {
        $val = $this->db
            ->select(
                "id,token,user_provider_id,type,currency_code,current_wallet,credit_wallet,debit_wallet,avail_wallet,total_amt,fee_amt,reason,created_at"
            )
