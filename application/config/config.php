...
*/
   ...
   $folder_name = str_replace(str_replace('\\','/',strtolower($_SERVER['DOCUMENT_ROOT'])), '', str_replace('\\','/',strtolower(FCPATH)));
...
// added by maksimU for Video/Audio chat
$config['VIDEOSERVER_PROTOCAL'] = 'https';
$config['VIDEOSERVER_ADDRESS'] = '10.10.11.21';
$config['VIDEOSERVER_PORT'] = 3000;
