...
class Myservice extends CI_Controller {
    ...
    public function index(){ 
        ...
        $config['base_url']    = base_url('staff/myservice/ajaxPaginationData'); 
    ...
    function ajaxPaginationData(){ 
        ...
        $this->load->view('staff/service/ajax-data', $this->data, false); 
    }
    ...
    { 
        ...
        // Pagination configuration 
        $config['target']      = '#dataList'; 
        $config['base_url']    = base_url('staff/myservice/inactiveajaxPaginationData'); 
        $config['total_rows']  = $totalRec; 
        $config['per_page']    = $this->perPage; 
     ...
     $this->load->view($this->data['theme'].'/template');
      ...
      function inactiveajaxPaginationData(){ 
        ...
        // Load the data list view 
        $this->load->view('staff/service/service-inactive-ajax-data', $this->data, false); 
    }
}