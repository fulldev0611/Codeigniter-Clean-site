...
class Dashboard extends MY_Controller
{
    ...
    */
    public function create_paypal_user_wallet()
    {
        ...
        $request->body = array(
            ...
            'cancel_url' => base_url() . 'staff/dashboard/paypal_add_wallet'],
    ...
    */
    ...
    /**
     * @author Leo: Staff Security Setting
    */
    public function staff_security()
    {
        $this->data['page'] = 'staff_security';
