...
class Promo_Code extends CI_Controller
{
    ...
    public function index($offset = 0)
    {
        ...
        $dataList = $this->PromotionModel->List();
    ...
    public function create()
    {
        ...
        if ($this->input->post('form_submit')) {
            if ($this->data['admin_id'] > 1) {
                ...
                if ($this->PromotionModel->add($data)) {
    ...
    {
        $this->data['page'] = 'edit';
        $datalist = $this->PromotionModel->get($id);
