...
class Affiliation extends CI_Controller
{
    ...
    public function index($offset = 0)
    {
        ...
        $dataList = $this->AffiliationModel->List();
    ...
    public function create()
    {
        ...
        if ($this->input->post('form_submit')) {
            if ($this->data['admin_id'] > 1) {
                ...
                if ($this->AffiliationModel->add($data)) {
    ...
    {
        $this->data['page'] = 'edit';
        $datalist = $this->AffiliationModel->get($id);
        ...
        if ($this->data['admin_id'] > 1) {
            ...
            if ($this->input->post('form_submit')) {
                ...
                $data['share_code'] = $this->input->post('share_code');
                // $data['start_date'] = $this->input->post('start_date'); 
                // $data['end_date'] = $this->input->post('end_date'); 
                
                if ($this->AffiliationModel->update($id, $data)) {
    ...
    public function delete()
    {
        if ($this->data['admin_id'] > 1) {
            ...
            if (!empty($id)) {
                ...
                $this->AffiliationModel->delete($id);
