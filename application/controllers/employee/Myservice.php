...
class Myservice extends MY_Controller
{
    ...
    public function index()
    {
        ...
        $config['base_url'] = base_url('employee/myservice/ajaxPaginationData');
    ...
    function ajaxPaginationData()
    {
        ...
        $this->load->view('employee/service/ajax-data', $this->data, false);
    }
    ...
    public function inactive_services()
    {
        ...
        // Pagination configuration
        $config['target'] = '#dataList';
        $config['base_url'] = base_url('employee/myservice/inactiveajaxPaginationData');
        $config['total_rows'] = $totalRec;
        $config['per_page'] = $this->perPage;
