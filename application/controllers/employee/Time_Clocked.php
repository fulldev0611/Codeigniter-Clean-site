...
class Time_Clocked extends MY_Controller {
   ...
   public function __construct() {
	...
	public function index($id)
	{
		...
		$shift_schedule = $this->db->where('id', $id)->get('shift_schedule')->result_array();
		$this->data['job_title'] = $shift_schedule[0]['schedule_job'];
		$this->data['location'] = $shift_schedule[0]['location'];
		$this->data['total_hour'] = $shift_schedule[0]['total_hours'];
		$this->data['shift_date'] = date('Y-m-d H:i:s');
