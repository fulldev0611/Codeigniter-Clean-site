...
class Myservice extends MY_Controller {
    ...
    public function index(){ 
        ...
        $config['base_url']    = base_url('organization/myservice/ajaxPaginationData'); 
    ...
    function ajaxPaginationData(){ 
        ...
        $this->load->view('organization/service/ajax-data', $this->data, false); 
    }
    ...
    { 
        ...
        // Pagination configuration 
        $config['target']      = '#dataList'; 
        $config['base_url']    = base_url('organization/myservice/inactiveajaxPaginationData'); 
        $config['total_rows']  = $totalRec; 
        $config['per_page']    = $this->perPage; 
     ...
     $this->load->view($this->data['theme'].'/template');
      ...
      function inactiveajaxPaginationData(){ 
        ...
        // Load the data list view 
        $this->load->view('employee/service/service-inactive-ajax-data', $this->data, false); 
    }
}